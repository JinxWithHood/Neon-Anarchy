...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // ==========================================
    // RENDER SERVER STARTUP LOADER (No Logs)
    // ==========================================
    ...
    let simInterval = setInterval(() => {
        ...
        if (currentProgress < 85) {
            currentProgress += Math.random() * 3 + 0.8;
            if (currentProgress > 85) currentProgress = 85;
            progressBar.style.width = `${Math.floor(currentProgress)}%`;
            statusText.textContent = `Aufwärmen des Render-Servers... ${Math.floor(currentProgress)}%`;
        }
    }, 70);
        ...
        link.addEventListener("click", (e) => {
                ...
                if (heroBannerImg) {
                    ...
                    setTimeout(() => {
                        if (targetTab === "home") {
                            ...
                            if (heroSubtitle) heroSubtitle.textContent = "Bist du bereit für das Chaos? Tritt unserer Community bei, zocke mit uns und erlebe spektakuläre Events im legendären Jinx-Hideout-Stil.";
            ...
            if (needsLoader) {
                ...
                if (targetTab === "archive") {
                    ...
                    statusText.textContent = "RETRIEVING ARCHIVES...";
                } else {
